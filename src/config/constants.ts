...
export const HOODBEAR_CONFIG = {
  ...
  X_PROFILE_URL: process.env.NEXT_PUBLIC_HOODBEAR_X_URL || 'https://x.com/HoodBearNFT',

  // Official HoodBear Featured Post URL for Like & RT (Task 02) and Comment (Task 03)
  X_POST_URL: process.env.NEXT_PUBLIC_HOODBEAR_POST_URL || 'https://x.com/HoodBearNFT/status/1888000000000000000',
